...
describe('isRelevantFile()', () => {
  ...
  describe('the file is not relevant', () => {
    ...
    it('for files in node_modules', () => {
      ...
      let file = path.join(paths.embroiderApp, 'node_modules/ember-resources/dist/index.js');
      let result = isRelevantFile(file);
    ...
    it('for files in .embroider/rewritten-packages', () => {
      ...
      let file = path.join(paths.embroiderApp, 'node_modules/.embroider/rewritten-packages/ember-source/dist/index.js');
      let result = isRelevantFile(file);
    ...
    it('for files in .embroider/rewritten-app/assets/tests.js', () => {
      ...
      let file = path.join(paths.embroiderApp, 'node_modules/.embroider/rewritten-app/assets/tests.js');
      let result = isRelevantFile(file);
