  ...
  return {
    visitor: {
      ...
      ImportDeclaration(path, state) {
        ...
        if (path.node.source.value === 'ember-scoped-css' || path.node.source.value === '@embroider/virtual/helpers/scopedClass' || path.node.source.value === '@embroider/virtual/helpers/scoped-class') {
